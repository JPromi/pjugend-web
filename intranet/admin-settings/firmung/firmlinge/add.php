...
<head>
    ...
    <title>Firmung <?php echo($firmung["year"]) ?> Firmling Anlegen - <?php echo($conf_title["intranet"]); ?></title>
            ...
            <div class="middle">
                ...
                <div class="bot">
                    <div class="single">
                        ...
                        <label><b>Vorname:</b> <input type="text" name="firstname" value="<?php echo $registration_firmling["firstname"] ?>" ></label>
                        <label><b>Mittelname:</b> <input type="text" name="middlename" value="<?php echo $registration_firmling["middlename"] ?>" ></label>
                        <label><b>Nachname:</b> <input type="text" name="lastname" value="<?php echo $registration_firmling["lastname"] ?>" ></label>
                        <label><b>Geburtsdatum:</b> <input type="date" name="birthdate" value="<?php echo date("Y-m-d", strtotime($registration_firmling["birthdate"])) ?>" ></label>
                    </div>
