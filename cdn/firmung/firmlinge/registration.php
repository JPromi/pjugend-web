...
//select Firmung
$firmling = "SELECT * FROM firmung_registration WHERE id = $regID AND firmung_id = $firmungID";
...
$imagePath = $_SERVER["DOCUMENT_ROOT"].'/firmung/firmlinge/_registration/'.$firmung["year"].'-'.$firmling["id"].'.jpg';
